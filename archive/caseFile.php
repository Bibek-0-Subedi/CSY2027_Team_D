<?php 
    ...
    if(!isset($_SESSION['adminSessionId'])==1){
                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-lg-5 form-container">
                            ...
                            <h5>Name : Php output with student name</h5>
                            <h5>Applied Course : Php output with student Course</h5>
                            <h5>Contact : Php output with student contact</h5>
                            <h5>Email : Php output with student email</h5>
