...
(1, 'This is a test title2', 'sfsdfdsfsdfsdf', 1, NULL, NULL, '2020-04-28 05:44:59'),
(2, 'dsfsdfsfd', 'sdfsdfsdfsd', 3, NULL, NULL, '2020-04-28 05:57:37'),
(3, 'sdffdsgdf', 'gdfgdsffgdfd', 3, NULL, NULL, '2020-04-28 05:59:24'),
(4, 'asdfghjkl;', 'asdfghjkl', 3, 2, NULL, '2020-04-28 06:00:46'),
(5, 'This is a test title2', 'gdfgdg', 1, NULL, NULL, '2020-04-29 06:06:13'),
(6, 'dgfhf', 'ghgfhgfg', 3, 1, 3, '2020-04-29 06:31:35'),
(9, 'fdgdffgdf', 'dgdfgdfg', 3, 2, 1, '2020-04-29 08:22:11');
...
INSERT INTO `diaries` (`diary_id`, `description`, `staff_id`, `student_id`, `date`) VALUES
(1, 'asfasfsa', 3, NULL, '2020-04-29 07:06:22');
...
(1, 2, 'Chapter 1', 'Lorem ipsum, dolor sit amet consectetur adipisicing elit. Recusandae commodi animi quos quae odit labore explicabo iusto, in sint voluptatem officia voluptas ipsum et deleniti ab consequuntur nihil ex quaerat?', 'dbchapter1.pdf', 0, '0000-00-00 00:00:00', 0, '2020-04-08 05:28:40'),
(2, 2, 'Chapter 2', 'Recusandae commodi animi quos quae odit labore explicabo iusto, in sint voluptatem officia voluptas ipsum et deleniti ab consequuntur nihil ex quaerat?', 'dbchapter2.pdf', 0, '0000-00-00 00:00:00', 0, '2020-04-08 05:28:40'),
(3, 1, 'Chapter 1', 'In sint voluptatem officia voluptas ipsum et deleniti ab consequuntur nihil ex quaerat?', 'secapter3.pdf', 0, '0000-00-00 00:00:00', 0, '2020-04-08 05:28:40'),
(4, 1, 'Chapter 2', 'Consectetur adipisicing elit. Recusandae commodi animi quos quae odit labore explicabo iusto, in sint voluptatem officia voluptas ipsum et deleniti ab consequuntur nihil ex quaerat?', 'sechapter4.pdf', 0, '0000-00-00 00:00:00', 0, '2020-04-08 05:28:40'),
(5, 2, 'asdas', 'sadasd', 'dbchapter11.pdf', 0, '0000-00-00 00:00:00', 0, '2020-04-08 16:37:38'),
(7, 1, 'dsfdfd', 'dfsfdsdfsfdsfds', '', 0, NULL, 0, '2020-04-29 07:43:34'),
(8, 1, 'zxcvbnbx', 'vcbzxcv', '', 0, NULL, 0, '2020-04-29 07:45:42'),
(9, 1, 'poiikjhbv', 'polkjmnb', '13 Comedy Structures.pdf', 0, NULL, 0, '2020-04-29 07:46:41'),
(10, 2, 'Tim Lee', '2020-01-01T01:00', '13 Comedy Structures.pdf', 1, NULL, 0, '2020-04-29 07:50:47');
...
(1, 1, 'admin', '', 'admin', '$2y$10$5J1F1t1bPapP.Ye43tx5luar/EL69S6P0ATm7wSNlPRyxo.KmJrSa', 'Woodland University', 123, 'admin@woodland.com', 0, 1, 0, NULL, 0, '2020-03-29 13:33:03', '2020-04-29 05:51:37'),
(2, 1, 'Leader', '', 'Leader', '$2y$10$8PyfsUXQiJX4ez4IQj1PFOBEoBsjpOw1ya2ueSy45m6ue/fvsWiTy', 'Woodland University', 123, 'leader@woodland.com', 0, 2, 0, NULL, 0, '2020-03-29 13:33:03', '2020-04-29 05:51:35'),
(3, 1, 'Tutor', '', 'Tutor', '$2y$10$bZ8zqaUGp93h/cvbtdhylOrrKAGMB3sRycZFOkO2REdpiZkBnpC9S', 'Woodland University', 123, 'tutor@woodland.com', 0, 3, 1, 'Firstname : Tutoradads<br>Subject : 11<br>', 0, '2020-03-29 13:34:22', '2020-04-29 06:06:44'),
(4, 1, 'ashish', '', 'Adhikari', '$2y$10$y35jDj58EHZvr0LSfZ.lS.26fZA3pIUofM57nSpDQ4IAvHmLafMeW', 'Bhaktapur', 334412, 'ashish@woodland.com', 12, 2, 0, NULL, 0, '2020-04-04 05:01:37', '2020-04-04 14:49:12');
...
(1002, 1002, 'ram@woodland.com', '$2y$10$um0qSWExh11ZzIzOQpoO..HFJdpPGa2Fm/M7vK9x0cC8V7OR1jT2m', 3, 0, 1, 'Firstname : Ramxzxz<br>', 1, '2020-04-07 09:48:54', '2020-04-29 08:33:37'),
...
(1016, 1016, 'ganesh@woodland.com', '$2y$10$ymQKHCKDn0skytiLANpcdeR6ZocbneROvFAjQtPB/.ZRQ0QgdwIgO', 3, 0, 0, NULL, 0, '2020-04-10 03:28:29', '2020-04-28 20:42:49');
...
--
ALTER TABLE `diaries`
  MODIFY `diary_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `module_files`
--
ALTER TABLE `module_files`
  MODIFY `file_id` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `timetables`
  MODIFY `routine_id` int(12) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
