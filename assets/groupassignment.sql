...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 15, 2020 at 04:17 PM
...
CREATE TABLE `students` (
  /*
  * student_id comes from assigned_id in admissions table.
  * No link required because admission_id does the linking
  * student_id is here for login and table linking purpose and has no auto increment
  * A row is added to the table when assigned id is created
  */
