...
<div class="container-fluid">
    ...
    <form action="<?= site_url() ?>module/update/<?= $modules['file_id'] ?>" method="POST" enctype="multipart/form-data">    
        ...
        <div class="form-group row">
             <label for="firstname" class="col-sm-2">Description: </label>
             <input type="text" value="<?= $modules['description']?>" class="form-control col-sm-2" name="description"> 
        </div>
        <div class="form-group row">
            <label for="firstname" class="col-sm-2">Upload Materials Here: </label>
