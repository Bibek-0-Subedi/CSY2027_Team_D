...
<div class="container-fluid">
    <div class="pl-sm-2 pr-sm-2 mt-2">
        ...
        <div class="row mt-3 float-right">
            <a href="<?= site_url(). 'tutor/module' ?>/assignment/view/<?= $modules['module_code'] ?>" class="btn btn-primary">View Uploaded Assignments</a>
        </div>
        <div class="row mt-3">
            <a href="<?= site_url(). 'tutor/module' ?>/assignment/add/<?= $modules['module_code'] ?>" class="btn btn-primary"> Upload Assignment </a>
        </div>
       <!--  <div class="row mt-4">
