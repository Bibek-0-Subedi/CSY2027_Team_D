<div class="container-fluid mx-3">
        ...
        <div class="row mt-3 pl-3">
            <a href="<?= site_url().'student/diary/add'?>" class="btn btn-outline-primary big-icon mr-3 mb-3 px-5"> 
            ...
            <div class="container-fluid">
                 <?php foreach ($diaries as $diary) { ?>
                            <div class="card">
                                ...
                                <a href="<?= site_url() ?>student/diary/edit/<?= $diary['diary_id']?>" class="btn btn-outline-primary pull-right">Edit</a> 
                            </div>
                        </div> 
                <?php } ?>
            </div>
