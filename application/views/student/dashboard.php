    ...
    <div class="row mb-5">
        <div class="card p-0 col-md-4 mr-4">
            <div class="card-header text-center mb-3">
                <h5 class="m-0">Student's Detail</h5>
            </div>
        ...
        <div class="card p-0 col-md-4 mr-4 notifs">
        ...
        <div class="card p-0 col-md-3" style="width: 18rem;">
            <div class="card-header">
                <h5 class="m-0">Time Table</h5>
            </div>
            <ul class="list-group list-group-flush">
                <?php foreach ($timetable as $routine) { ?>
                    <li class="list-group-item"><a href="viewTimeTable/<?= $routine['routine_id'] ?>">TimeTable for <?= $routine['year']?></a></li>
                <?php }?>
            </ul>
        </div>
    </div>
